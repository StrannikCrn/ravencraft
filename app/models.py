...
class Bottle(models.Model):
    ...
    image_index = models.ImageField(upload_to="app/static/images/bottles/", verbose_name="Картинка на главную", null=True)
    image_index_dark = models.ImageField(upload_to="app/static/images/bottles", verbose_name="Картинка на главную (затемнённая)", null=True)
